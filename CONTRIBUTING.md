# Contributing to command-line-args
...
* **Did the problem start happening recently** (e.g. after updating to a new version of command-line-args) or was this always a problem?
* If the problem started happening recently, **can you reproduce the problem in an older version of command-line-args ?** What's the most recent version in which the problem doesn't happen? You can download older versions of command-line-args from [the releases page](https://github.com/digipolitan/command-line-args/releases).
* **Can you reliably reproduce the issue?** If not, provide details about how often the problem happens and under which conditions it normally happens.

Include details about your configuration and environment:

* **Which version of command-line-args are you using?
...
#### Template For Submitting Bug Reports
    ...
    **command-line-args version:** [Enter command-line-args version here]
    ...
    * Problem started happening recently, didn't happen in an older version of command-line-args: [Yes/No]
